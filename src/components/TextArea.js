...
export default function TextArea(props) {
  ...
  return (
    ...
    <form className="container" style={{color:props.mode === 'dark' ? 'white' : 'black'}}>
      ...
      <button type="button" onClick={handleClickUp} className="btn btn-primary mx-2">Convert to Uppercase</button>
      <button type="button" onClick={handleClickLow} className="btn btn-success mx-2">Convert to Lowercase</button>
      <button type="button" onClick={handleClickCap} className="btn btn-primary mx-2">Convert to Capitalize</button>
      <button type="button" onClick={handleClickCCopy} className="btn btn-success mx-2">Copy Text</button>
      <button type="button" onClick={handleClickClear} className="btn btn-primary mx-2">Clear Text</button>
      <button type="button" onClick={handleExtraSpaces} className="btn btn-success mx-2">Remove Extra Spaces</button>
    </form>
